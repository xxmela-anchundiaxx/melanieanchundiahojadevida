...
class ProductosAcademicos(models.Model):
    ...
    archivo = models.FileField(upload_to='productos_academicos/', blank=True, null=True)
...
class VentaGarage(models.Model):
    ...
    imagen_producto = models.ImageField(upload_to='ventas_garage/', blank=True, null=True)
